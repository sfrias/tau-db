...
public class StatisticsTab extends JPanel{
	...
	private void createTopFiveLastSuccessfulSearchesPanel(){
		createListPanel(topFiveSuccessfulFirstCharLabels, topFiveSuccessfulSecondCharLabels, topFiveSuccessfulDateLabels, "Date", "Last 5 Successful Searches");
	}
	...
	public void refreshFromModel(){
		...
		successRateLabel.setText(Long.toString(successRate.getSuccessSearches() / successRate.getTotalSearches() * 100 ) + "%");
	}
