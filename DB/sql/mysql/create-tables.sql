...
CREATE TABLE gender
	...
	gender_fb_id varchar(40) NOT NULL DEFAULT '',
...
CREATE TABLE universe
	...
	PRIMARY KEY (universe_id,universe_fb_id)) ENGINE=InnoDB;
...
CREATE TABLE location
	...
	FOREIGN KEY (location_universe_id) REFERENCES universe (universe_id)) ENGINE=InnoDB;
...
CREATE TABLE rank
	...
	rank_fb_id varchar(40) NOT NULL DEFAULT '',
	rank_name varchar(80) NOT NULL,
	KEY ix_rank_id (rank_id),
	PRIMARY KEY (rank_id)) ENGINE=InnoDB;
	
CREATE TABLE ethnicity
	(ethnicity_id int(11) NOT NULL AUTO_INCREMENT,
	ethnicity_fb_id varchar(40) NOT NULL DEFAULT '',
...
CREATE TABLE job 
	...
	job_fb_id varchar(40) NOT NULL DEFAULT '',
...
CREATE TABLE characters_and_gender 
	...
	FOREIGN KEY (characters_and_gender_gender_id) REFERENCES gender(gender_id) ON UPDATE RESTRICT ON DELETE RESTRICT) ENGINE=InnoDB;
...
CREATE TABLE characters_and_species 
	...
	FOREIGN KEY (characters_and_species_character_id) REFERENCES characters(character_id) ON UPDATE RESTRICT ON DELETE CASCADE,
	FOREIGN KEY (characters_and_species_species_id) REFERENCES species(species_id) ON UPDATE RESTRICT ON DELETE RESTRICT) ENGINE=InnoDB;
...
CREATE TABLE characters_and_creator 
	...
	FOREIGN KEY (characters_and_creator_character_id) REFERENCES characters(character_id) ON UPDATE RESTRICT ON DELETE CASCADE,
	FOREIGN KEY (characters_and_creator_creator_id) REFERENCES creator(creator_id) ON UPDATE RESTRICT ON DELETE RESTRICT) ENGINE=InnoDB;
...
CREATE TABLE characters_and_rank 
	...
	FOREIGN KEY (characters_and_rank_character_id) REFERENCES characters(character_id) ON UPDATE RESTRICT ON DELETE CASCADE,
	FOREIGN KEY (characters_and_rank_rank_id) REFERENCES rank(rank_id) ON UPDATE RESTRICT ON DELETE RESTRICT) ENGINE=InnoDB;
...
CREATE TABLE characters_and_ethnicity 
	...
	FOREIGN KEY (characters_and_ethnicity_character_id) REFERENCES characters(character_id) ON UPDATE RESTRICT ON DELETE CASCADE,
	FOREIGN KEY (characters_and_ethnicity_ethnicity_id) REFERENCES ethnicity(ethnicity_id) ON UPDATE RESTRICT ON DELETE RESTRICT) ENGINE=InnoDB;
...
CREATE TABLE marriage 
	...
	FOREIGN KEY (marriage_character_id1) REFERENCES characters(character_id) ON UPDATE RESTRICT ON DELETE CASCADE,
	FOREIGN KEY (marriage_character_id2) REFERENCES characters(character_id) ON UPDATE RESTRICT ON DELETE CASCADE) ENGINE=InnoDB;
...
CREATE TABLE sibling
	...
	FOREIGN KEY (sibling_character_id1) REFERENCES characters(character_id) ON UPDATE RESTRICT ON DELETE CASCADE,
	FOREIGN KEY (sibling_character_id2) REFERENCES characters(character_id) ON UPDATE RESTRICT ON DELETE CASCADE) ENGINE=InnoDB;
...
CREATE TABLE characters_and_job
	...
	FOREIGN KEY (characters_and_job_job_id) REFERENCES job(job_id) ON UPDATE RESTRICT ON DELETE CASCADE,
	FOREIGN KEY (characters_and_job_character_id) REFERENCES characters(character_id) ON UPDATE RESTRICT ON DELETE CASCADE) ENGINE=InnoDB;
